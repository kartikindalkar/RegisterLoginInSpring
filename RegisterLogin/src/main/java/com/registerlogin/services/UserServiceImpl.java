package com.registerlogin.services;
...
public class UserServiceImpl implements UserService{
	...
	public void sendEmail(User user, String path) {
		...
		String content = "Dear [[name]],<br>" + "Please click the link below to verify your registration:<br>"
				+ "<h3><a href=\"[[URL]]\" target=\"_self\">VERIFY</a></h3>" + "Thank you,<br>" + "CityCare";
...
//	private static final long lock_duration_time=24*60*60*1000;
	...
	public static final long ATTEMTP_TIME = 3;
	...
	public boolean unlockAccountTimeExpired(User user) {
		...
		if(lockTimeInMills+lock_duration_time < currentTimeMilles) {
			user.setAccountNonLocked(true);
			user.setLockTime(null);
			user.setFailedAttempt(0);
			userRepo.save(user);
